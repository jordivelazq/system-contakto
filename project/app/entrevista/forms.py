...
class EntrevistaPrestacionViviendaForma(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(EntrevistaPrestacionViviendaForma,
...
class EntrevistaDeudaActualForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        fields_money_format = ['cantidad_total',
                               'saldo_actual', 'pago_mensual']
...
class EntrevistaCitaForm(ModelForm):
    autorizada = forms.ChoiceField(
        choices=ACTIVO_OPCIONES, initial='0', label='Entrevista autorizada')
    entrevistador = forms.CharField(
        label='Enviado a entrevistador:', required=False)

    class Meta:
        model = EntrevistaCita
        fields = ('entrevistador', 'fecha_entrevista',
                  'hora_entrevista', 'autorizada')
...
class EntrevistaPersonaForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ('nombre', 'apellido', 'email', 'rfc', 'curp', 'ife', 'smn', 'pasaporte', 'nss', 'estado_civil',
                  'fecha_matrimonio', 'religion', 'tiempo_radicando', 'medio_utilizado', 'referencia_vacante', 'tiempo_transporte')
...
class EntrevistaPersonaInfoEconomicaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(EntrevistaPersonaInfoEconomicaForm,
              self).__init__(*args, **kwargs)
...
class EntrevistaPropietarioViviendaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(EntrevistaPropietarioViviendaForm,
              self).__init__(*args, **kwargs)
        for field_name, field in self.fields.items():
            field.widget.attrs['class'] = 'form-control'
...
class EntrevistaCaractaristicasViviendaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(EntrevistaCaractaristicasViviendaForm,
              self).__init__(*args, **kwargs)
        ...
        for field_name, field in self.fields.items():
            field.widget.attrs['class'] = field.widget.attrs['class'] + \
                ' form-control' if 'class' in field.widget.attrs else 'form-control'
...
class EntrevistaDistribucionDimensionesForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(EntrevistaDistribucionDimensionesForm,
              self).__init__(*args, **kwargs)
        for field_name, field in self.fields.items():
            field.widget.attrs['class'] = 'form-control'
...
class EntrevistaObservacionesForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['hora_entrevista'].widget.attrs.update(
...
class MoneyFormatEntrevistaEconomicaForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(MoneyFormatEntrevistaEconomicaForm,
              self).__init__(*args, **kwargs)
