...
class EntrevistaPersonaForm(ModelForm):
	...
	class Meta:  
		...
		fields = ('nombre', 'apellido', 'email', 'rfc', 'curp', 'ife', 'smn', 'pasaporte', 'nss', 'estado_civil', 'fecha_matrimonio', 'religion', 'tiempo_radicando', 'medio_utilizado', 'referencia_vacante', 'tiempo_transporte', 'conclusion')
