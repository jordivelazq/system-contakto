...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaDireccion.num'
        db.add_column('entrevista_entrevistadireccion', 'num',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaDireccion.num'
        db.delete_column('entrevista_entrevistadireccion', 'num')
