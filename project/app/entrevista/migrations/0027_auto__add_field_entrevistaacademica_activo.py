...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaAcademica.activo'
        db.add_column('entrevista_entrevistaacademica', 'activo',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaAcademica.activo'
        db.delete_column('entrevista_entrevistaacademica', 'activo')
