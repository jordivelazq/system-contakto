...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaPersona.referencia_vacante'
        db.add_column('entrevista_entrevistapersona', 'referencia_vacante',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaPersona.tiempo_transporte'
        db.add_column('entrevista_entrevistapersona', 'tiempo_transporte',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaPersona.referencia_vacante'
        db.delete_column('entrevista_entrevistapersona', 'referencia_vacante')

        # Deleting field 'EntrevistaPersona.tiempo_transporte'
        db.delete_column('entrevista_entrevistapersona', 'tiempo_transporte')
