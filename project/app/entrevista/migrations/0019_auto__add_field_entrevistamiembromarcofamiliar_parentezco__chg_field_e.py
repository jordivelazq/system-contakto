...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaMiembroMarcoFamiliar.parentezco'
        db.add_column('entrevista_entrevistamiembromarcofamiliar', 'parentezco',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EntrevistaPersona.nombre'
        db.alter_column('entrevista_entrevistapersona', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):
        # Deleting field 'EntrevistaMiembroMarcoFamiliar.parentezco'
        db.delete_column('entrevista_entrevistamiembromarcofamiliar', 'parentezco')


        # Changing field 'EntrevistaPersona.nombre'
        db.alter_column('entrevista_entrevistapersona', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=140))
    ...
    models = {
        ...
        'entrevista.entrevistamiembromarcofamiliar': {
            ...
            'parentezco': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['entrevista.EntrevistaPersona']"}),
