...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaSituacionVivienda.domicilio_anterior'
        db.add_column('entrevista_entrevistasituacionvivienda', 'domicilio_anterior',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaSituacionVivienda.domicilio_anterior'
        db.delete_column('entrevista_entrevistasituacionvivienda', 'domicilio_anterior')
