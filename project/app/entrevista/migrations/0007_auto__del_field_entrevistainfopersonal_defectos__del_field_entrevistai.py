...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntrevistaInfoPersonal.defectos'
        db.delete_column('entrevista_entrevistainfopersonal', 'defectos')

        # Deleting field 'EntrevistaInfoPersonal.trabajo_que_desarrolla'
        db.delete_column('entrevista_entrevistainfopersonal', 'trabajo_que_desarrolla')

        # Deleting field 'EntrevistaInfoPersonal.objetivo_en_empresa'
        db.delete_column('entrevista_entrevistainfopersonal', 'objetivo_en_empresa')

        # Deleting field 'EntrevistaInfoPersonal.objetivo_personal'
        db.delete_column('entrevista_entrevistainfopersonal', 'objetivo_personal')

        # Deleting field 'EntrevistaInfoPersonal.cualidades'
        db.delete_column('entrevista_entrevistainfopersonal', 'cualidades')


    def backwards(self, orm):
        # Adding field 'EntrevistaInfoPersonal.defectos'
        db.add_column('entrevista_entrevistainfopersonal', 'defectos',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaInfoPersonal.trabajo_que_desarrolla'
        db.add_column('entrevista_entrevistainfopersonal', 'trabajo_que_desarrolla',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaInfoPersonal.objetivo_en_empresa'
        db.add_column('entrevista_entrevistainfopersonal', 'objetivo_en_empresa',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaInfoPersonal.objetivo_personal'
        db.add_column('entrevista_entrevistainfopersonal', 'objetivo_personal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'EntrevistaInfoPersonal.cualidades'
        db.add_column('entrevista_entrevistainfopersonal', 'cualidades',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)
