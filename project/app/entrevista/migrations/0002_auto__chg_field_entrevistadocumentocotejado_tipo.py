...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntrevistaDocumentoCotejado.tipo'
        db.alter_column('entrevista_entrevistadocumentocotejado', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EntrevistaDocumentoCotejado.tipo'
        db.alter_column('entrevista_entrevistadocumentocotejado', 'tipo', self.gf('django.db.models.fields.CharField')(max_length=20))
