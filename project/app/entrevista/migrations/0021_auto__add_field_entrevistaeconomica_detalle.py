...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaEconomica.detalle'
        db.add_column('entrevista_entrevistaeconomica', 'detalle',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaEconomica.detalle'
        db.delete_column('entrevista_entrevistaeconomica', 'detalle')
