...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaPrestacionVivienda.motivo'
        db.add_column('entrevista_entrevistaprestacionvivienda', 'motivo',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaPrestacionVivienda.motivo'
        db.delete_column('entrevista_entrevistaprestacionvivienda', 'motivo')
