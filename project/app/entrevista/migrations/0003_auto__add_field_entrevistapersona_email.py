...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaPersona.email'
        db.add_column('entrevista_entrevistapersona', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaPersona.email'
        db.delete_column('entrevista_entrevistapersona', 'email')
