...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntrevistaActividadesHabitos.tiempo_libre'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'tiempo_libre')

        # Adding field 'EntrevistaActividadesHabitos.inactividad_laboral'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'inactividad_laboral',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaActividadesHabitos.inactividad_laboral_actividad'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'inactividad_laboral_actividad',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaActividadesHabitos.negocios'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'negocios',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaActividadesHabitos.negocios_actividad'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'negocios_actividad',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EntrevistaActividadesHabitos.tiempo_libre'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'tiempo_libre',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EntrevistaActividadesHabitos.inactividad_laboral'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'inactividad_laboral')

        # Deleting field 'EntrevistaActividadesHabitos.inactividad_laboral_actividad'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'inactividad_laboral_actividad')

        # Deleting field 'EntrevistaActividadesHabitos.negocios'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'negocios')

        # Deleting field 'EntrevistaActividadesHabitos.negocios_actividad'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'negocios_actividad')
