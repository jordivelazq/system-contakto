...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaPersona.religion_tiempo'
        db.add_column('entrevista_entrevistapersona', 'religion_tiempo',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EntrevistaPersona.religion'
        db.alter_column('entrevista_entrevistapersona', 'religion', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):
        # Deleting field 'EntrevistaPersona.religion_tiempo'
        db.delete_column('entrevista_entrevistapersona', 'religion_tiempo')


        # Changing field 'EntrevistaPersona.religion'
        db.alter_column('entrevista_entrevistapersona', 'religion', self.gf('django.db.models.fields.CharField')(default='', max_length=140))
