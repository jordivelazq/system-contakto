...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntrevistaMiembroMarcoFamiliar.parentesco'
        db.add_column('entrevista_entrevistamiembromarcofamiliar', 'parentesco',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EntrevistaMiembroMarcoFamiliar.parentesco'
        db.delete_column('entrevista_entrevistamiembromarcofamiliar', 'parentesco')
