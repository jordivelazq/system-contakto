...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaDireccion.investigacion'
        db.add_column('entrevista_entrevistadireccion', 'investigacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['investigacion.Investigacion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaDireccion.investigacion'
        db.delete_column('entrevista_entrevistadireccion', 'investigacion_id')
