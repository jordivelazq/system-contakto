...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaHistorialEnEmpresa.motivo_salida'
        db.add_column('entrevista_entrevistahistorialenempresa', 'motivo_salida',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaHistorialEnEmpresa.motivo_salida'
        db.delete_column('entrevista_entrevistahistorialenempresa', 'motivo_salida')
