...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaFile.tipo'
        db.add_column('entrevista_entrevistafile', 'tipo',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaFile.tipo'
        db.delete_column('entrevista_entrevistafile', 'tipo')
