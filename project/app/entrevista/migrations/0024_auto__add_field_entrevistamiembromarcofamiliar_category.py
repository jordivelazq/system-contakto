...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaMiembroMarcoFamiliar.category'
        db.add_column('entrevista_entrevistamiembromarcofamiliar', 'category',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaMiembroMarcoFamiliar.category'
        db.delete_column('entrevista_entrevistamiembromarcofamiliar', 'category')
