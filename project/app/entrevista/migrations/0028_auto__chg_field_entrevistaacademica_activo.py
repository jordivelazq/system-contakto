...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntrevistaAcademica.activo'
        db.alter_column('entrevista_entrevistaacademica', 'activo', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'EntrevistaAcademica.activo'
        db.alter_column('entrevista_entrevistaacademica', 'activo', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
