...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaReferencia.tipo'
        db.add_column('entrevista_entrevistareferencia', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaReferencia.tipo'
        db.delete_column('entrevista_entrevistareferencia', 'tipo')
