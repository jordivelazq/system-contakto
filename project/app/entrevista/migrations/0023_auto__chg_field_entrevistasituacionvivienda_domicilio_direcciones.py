...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntrevistaSituacionVivienda.domicilio_direcciones'
        db.alter_column('entrevista_entrevistasituacionvivienda', 'domicilio_direcciones', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'EntrevistaSituacionVivienda.domicilio_direcciones'
        db.alter_column('entrevista_entrevistasituacionvivienda', 'domicilio_direcciones', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
