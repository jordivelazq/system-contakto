...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EntrevistaActividadesHabitos.extras'
        db.delete_column('entrevista_entrevistaactividadeshabitos', 'extras')

        # Deleting field 'EntrevistaAcademica.estudios_actuales'
        db.delete_column('entrevista_entrevistaacademica', 'estudios_actuales')

        # Adding field 'EntrevistaAcademica.estudios_institucion'
        db.add_column('entrevista_entrevistaacademica', 'estudios_institucion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaAcademica.estudios_que'
        db.add_column('entrevista_entrevistaacademica', 'estudios_que',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaAcademica.estudios_horarios'
        db.add_column('entrevista_entrevistaacademica', 'estudios_horarios',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaAcademica.estudios_dias'
        db.add_column('entrevista_entrevistaacademica', 'estudios_dias',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EntrevistaOtroIdioma.porcentaje'
        db.delete_column('entrevista_entrevistaotroidioma', 'porcentaje')

        # Adding field 'EntrevistaOtroIdioma.hablado'
        db.add_column('entrevista_entrevistaotroidioma', 'hablado',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaOtroIdioma.leido'
        db.add_column('entrevista_entrevistaotroidioma', 'leido',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaOtroIdioma.escuchado'
        db.add_column('entrevista_entrevistaotroidioma', 'escuchado',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EntrevistaActividadesHabitos.extras'
        db.add_column('entrevista_entrevistaactividadeshabitos', 'extras',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrevistaAcademica.estudios_actuales'
        db.add_column('entrevista_entrevistaacademica', 'estudios_actuales',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EntrevistaAcademica.estudios_institucion'
        db.delete_column('entrevista_entrevistaacademica', 'estudios_institucion')

        # Deleting field 'EntrevistaAcademica.estudios_que'
        db.delete_column('entrevista_entrevistaacademica', 'estudios_que')

        # Deleting field 'EntrevistaAcademica.estudios_horarios'
        db.delete_column('entrevista_entrevistaacademica', 'estudios_horarios')

        # Deleting field 'EntrevistaAcademica.estudios_dias'
        db.delete_column('entrevista_entrevistaacademica', 'estudios_dias')

        # Adding field 'EntrevistaOtroIdioma.porcentaje'
        db.add_column('entrevista_entrevistaotroidioma', 'porcentaje',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EntrevistaOtroIdioma.hablado'
        db.delete_column('entrevista_entrevistaotroidioma', 'hablado')

        # Deleting field 'EntrevistaOtroIdioma.leido'
        db.delete_column('entrevista_entrevistaotroidioma', 'leido')

        # Deleting field 'EntrevistaOtroIdioma.escuchado'
        db.delete_column('entrevista_entrevistaotroidioma', 'escuchado')
