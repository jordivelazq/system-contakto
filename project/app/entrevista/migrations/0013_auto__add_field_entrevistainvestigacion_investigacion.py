...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrevistaInvestigacion.investigacion'
        db.add_column('entrevista_entrevistainvestigacion', 'investigacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['investigacion.Investigacion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrevistaInvestigacion.investigacion'
        db.delete_column('entrevista_entrevistainvestigacion', 'investigacion_id')
