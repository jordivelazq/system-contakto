...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EntrevistaCita.hora_entrevista'
        db.alter_column('entrevista_entrevistacita', 'hora_entrevista', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'EntrevistaCita.fecha_entrevista'
        db.alter_column('entrevista_entrevistacita', 'fecha_entrevista', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'EntrevistaCita.hora_entrevista'
        db.alter_column('entrevista_entrevistacita', 'hora_entrevista', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'EntrevistaCita.fecha_entrevista'
        db.alter_column('entrevista_entrevistacita', 'fecha_entrevista', self.gf('django.db.models.fields.DateField')(null=True))
