...
class EntrevistaFile(models.Model):
    ...
    tipo = models.IntegerField(
        default=0, choices=ARCHIVO_OPCIONES, blank=True, null=True)
...
class EntrevistaInvestigacion(models.Model):
    ...
    fecha_recibido = models.CharField(
        max_length=140, blank=True, null=True)  # Del excel
    ...
    resultado = models.CharField(
        max_length=30, choices=RESULTADO_OPCIONES, blank=True, null=True)
    archivo = models.ForeignKey(
        EntrevistaFile, blank=True, null=True, on_delete=models.CASCADE)
...
class EntrevistaCita(models.Model):
    ...
    autorizada = models.IntegerField(
...
class EntrevistaDireccion(models.Model):
    ...
    num = models.CharField(verbose_name='Num ext-int',
                           max_length=140, null=True, blank=True)
    ciudad = models.CharField(verbose_name='Ciudad',
                              max_length=140, null=True, blank=True)
    colonia = models.CharField(
        verbose_name='Colonia o fraccionamiento', max_length=140, null=True, blank=True)
    cp = models.CharField(verbose_name='Código Postal',
                          max_length=140, null=True, blank=True)
...
class EntrevistaLicencia(models.Model):
    ...
    numero = models.CharField(
        verbose_name='No. de licencia', max_length=20, null=True, blank=True)
    tipo = models.CharField(verbose_name='Tipo de licencia',
                            max_length=140, null=True, blank=True)
...
class EntrevistaOrigen(models.Model):
    ...
    lugar = models.CharField(
        verbose_name='Lugar de nacimiento', max_length=140, null=True, blank=True)
    nacionalidad = models.CharField(max_length=140, null=True, blank=True)
    fecha = models.CharField(
        verbose_name='Fecha de nacimiento', max_length=140, null=True, blank=True)
...
class EntrevistaInfoPersonal(models.Model):
    ...
    antecedentes_penales = models.CharField(
        verbose_name='Demandas Laborales y/o Antecedentes Penales', max_length=500, null=True, blank=True)
    tatuajes = models.CharField(
        verbose_name='Cuenta con algún tatuaje o arete:(Cuantos y en que parte del cuerpo)', max_length=500, null=True, blank=True)
...
class EntrevistaHistorialEnEmpresa(models.Model):
    ...
    tiene = models.CharField(max_length=140, null=True,
                             blank=True, choices=TIENE_OPCIONES)
    puesto = models.CharField(max_length=500, null=True, blank=True)
    # Solo para categ. trabajo
    periodo = models.CharField(max_length=500, null=True, blank=True)
    # Solo para cate. familiar
    ...
    motivo_salida = models.CharField(
        max_length=140, null=True, blank=True)  # Solo para categ. trabajo
    parentesco = models.CharField(
        max_length=140, null=True, blank=True)  # Solo para cate. familiar
...
class EntrevistaSalud(models.Model):
    ...
    ejercicio_tipo_frecuencia = models.CharField(
        max_length=200, null=True, blank=True)
    accidentes = models.CharField(max_length=200, null=True, blank=True)
    intervenciones_quirurgicas = models.CharField(
        max_length=200, null=True, blank=True)
    enfermedades_familiares = models.CharField(
        max_length=200, null=True, blank=True)
    tratamiento_medico_psicologico = models.CharField(
        max_length=200, null=True, blank=True)
    enfermedades_mayor_frecuencia = models.CharField(
        max_length=200, null=True, blank=True)
    institucion_medica = models.CharField(
        max_length=200, null=True, blank=True)
...
class EntrevistaAcademica(models.Model):
    ...
    cedula_profesional = models.CharField(
        max_length=200, null=True, blank=True)
    cedula_prof_ano_exp = models.CharField(
        max_length=200, null=True, blank=True)
    estudios_institucion = models.CharField(
        max_length=200, null=True, blank=True)
...
class EntrevistaSituacionVivienda(models.Model):
    ...
    sector_socioeconomico = models.CharField(
        max_length=200, null=True, blank=True)
    personas_viven_con_evaluado = models.CharField(
        max_length=200, null=True, blank=True)
    ...
    domicilio_anterior = models.CharField(
        max_length=500, null=True, blank=True)
...
class EntrevistaPropietarioVivienda(models.Model):
    ...
    nombre = models.CharField(
        verbose_name='Nombre del propietario', max_length=200, null=True, blank=True)
...
class EntrevistaMiembroMarcoFamiliar(models.Model):
    ...
    category = models.CharField(
        max_length=140, default=1, choices=FAMILIAR_OPCIONES)
...
class EntrevistaDeudaActual(models.Model):
    person = models.ForeignKey(EntrevistaPersona, on_delete=models.CASCADE)
    fecha_otorgamiento = models.CharField(
        max_length=140, null=True, blank=True)
    tipo = models.CharField(max_length=140, null=True, blank=True)
    institucion = models.CharField(max_length=140, null=True, blank=True)
...
class EntrevistaReferencia(models.Model):
    ...
    lugares_labor_evaluado = models.CharField(
        max_length=200, blank=True, null=True)
    opinion = models.TextField(max_length=500, blank=True, null=True)
    tipo = models.CharField(
        max_length=20, choices=REFERENCIA_TIPO_OPCIONES, default='')
...
class EntrevistaDocumentoCotejado(models.Model):
    ...
    # Solo se usa para el tipo 'motivos_falta_docs'
