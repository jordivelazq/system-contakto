...
from app.investigacion.models import Investigacion, Psicometrico, PsicometricoUser, GestorInvestigacion, GestorInvestigacionPago, GestorInvestigacionPagoInv
...
class GestorInvestigacionAdmin(admin.ModelAdmin):
    list_display = ('id', 'gestor', 'investigacion', 'fecha_atencion', 'pagado', 'completado')
    readonly_fields = ["investigacion",]
