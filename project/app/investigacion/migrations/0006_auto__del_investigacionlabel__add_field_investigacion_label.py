...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'InvestigacionLabel'
        db.delete_table('investigacion_investigacionlabel')

        # Adding field 'Investigacion.label'
        db.add_column('investigacion_investigacion', 'label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agente.Labels'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'InvestigacionLabel'
        db.create_table('investigacion_investigacionlabel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('investigacion', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['investigacion.Investigacion'], unique=True)),
            ('label', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agente.Labels'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('investigacion', ['InvestigacionLabel'])

        # Deleting field 'Investigacion.label'
        db.delete_column('investigacion_investigacion', 'label_id')
