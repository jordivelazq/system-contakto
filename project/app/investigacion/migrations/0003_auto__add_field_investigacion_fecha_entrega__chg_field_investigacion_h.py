...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigacion.fecha_entrega'
        db.add_column('investigacion_investigacion', 'fecha_entrega',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Investigacion.hora_recibido'
        db.alter_column('investigacion_investigacion', 'hora_recibido', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):
        # Deleting field 'Investigacion.fecha_entrega'
        db.delete_column('investigacion_investigacion', 'fecha_entrega')


        # Changing field 'Investigacion.hora_recibido'
        db.alter_column('investigacion_investigacion', 'hora_recibido', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
