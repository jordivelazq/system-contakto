...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigacion.hora_recibido'
        db.add_column('investigacion_investigacion', 'hora_recibido',
                      self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Investigacion.tipo_investigacion_texto'
        db.alter_column('investigacion_investigacion', 'tipo_investigacion_texto', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True))

    def backwards(self, orm):
        # Deleting field 'Investigacion.hora_recibido'
        db.delete_column('investigacion_investigacion', 'hora_recibido')


        # Changing field 'Investigacion.tipo_investigacion_texto'
        db.alter_column('investigacion_investigacion', 'tipo_investigacion_texto', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
    ...
    models = {
        ...
        'investigacion.investigacion': {
            ...
            'hora_recibido': ('django.db.models.fields.TextField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
