...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigacion.sucursal'
        db.add_column('investigacion_investigacion', 'sucursal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compania.Sucursales'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigacion.sucursal'
        db.delete_column('investigacion_investigacion', 'sucursal_id')
