...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'investigacion.investigacionlabel': {
            'Meta': {'object_name': 'InvestigacionLabel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigacion': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['investigacion.Investigacion']", 'unique': 'True'}),
            'label': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['agente.Labels']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'persona.file': {
