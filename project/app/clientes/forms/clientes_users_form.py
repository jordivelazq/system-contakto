...
class ClienteUserForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        try:
            ...
            ClienteUser.objects.get(username=username)
...
class ClienteUserEditForm(forms.ModelForm):
...
class ClienteUserPasswdForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ClienteUserPasswdForm, self).__init__(*args, **kwargs)
        if user_details:
