...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrayectoriaLaboral.jefe_inmediato'
        db.delete_column('persona_trayectorialaboral', 'jefe_inmediato')

        # Deleting field 'TrayectoriaLaboral.carta_laboral'
        db.delete_column('persona_trayectorialaboral', 'carta_laboral')

        # Deleting field 'TrayectoriaLaboral.carta_laboral_expide'
        db.delete_column('persona_trayectorialaboral', 'carta_laboral_expide')

        # Deleting field 'TrayectoriaLaboral.manejo_valores'
        db.delete_column('persona_trayectorialaboral', 'manejo_valores')

        # Deleting field 'TrayectoriaLaboral.afiliado_sindicato'
        db.delete_column('persona_trayectorialaboral', 'afiliado_sindicato')

        # Deleting field 'TrayectoriaLaboral.jefe_inmediato_puesto'
        db.delete_column('persona_trayectorialaboral', 'jefe_inmediato_puesto')


    def backwards(self, orm):
        # Adding field 'TrayectoriaLaboral.jefe_inmediato'
        db.add_column('persona_trayectorialaboral', 'jefe_inmediato',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.carta_laboral'
        db.add_column('persona_trayectorialaboral', 'carta_laboral',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.carta_laboral_expide'
        db.add_column('persona_trayectorialaboral', 'carta_laboral_expide',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.manejo_valores'
        db.add_column('persona_trayectorialaboral', 'manejo_valores',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.afiliado_sindicato'
        db.add_column('persona_trayectorialaboral', 'afiliado_sindicato',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.jefe_inmediato_puesto'
        db.add_column('persona_trayectorialaboral', 'jefe_inmediato_puesto',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)
