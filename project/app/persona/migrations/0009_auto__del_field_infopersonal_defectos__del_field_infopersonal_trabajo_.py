...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InfoPersonal.defectos'
        db.delete_column('persona_infopersonal', 'defectos')

        # Deleting field 'InfoPersonal.trabajo_que_desarrolla'
        db.delete_column('persona_infopersonal', 'trabajo_que_desarrolla')

        # Deleting field 'InfoPersonal.objetivo_en_empresa'
        db.delete_column('persona_infopersonal', 'objetivo_en_empresa')

        # Deleting field 'InfoPersonal.objetivo_personal'
        db.delete_column('persona_infopersonal', 'objetivo_personal')

        # Deleting field 'InfoPersonal.cualidades'
        db.delete_column('persona_infopersonal', 'cualidades')


    def backwards(self, orm):
        # Adding field 'InfoPersonal.defectos'
        db.add_column('persona_infopersonal', 'defectos',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'InfoPersonal.trabajo_que_desarrolla'
        db.add_column('persona_infopersonal', 'trabajo_que_desarrolla',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'InfoPersonal.objetivo_en_empresa'
        db.add_column('persona_infopersonal', 'objetivo_en_empresa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'InfoPersonal.objetivo_personal'
        db.add_column('persona_infopersonal', 'objetivo_personal',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'InfoPersonal.cualidades'
        db.add_column('persona_infopersonal', 'cualidades',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)
