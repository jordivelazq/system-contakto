...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrayectoriaLaboral.aportaciones_fecha_final'
        db.delete_column('persona_trayectorialaboral', 'aportaciones_fecha_final')

        # Deleting field 'TrayectoriaLaboral.aportaciones_fecha_inicial'
        db.delete_column('persona_trayectorialaboral', 'aportaciones_fecha_inicial')

        # Adding field 'TrayectoriaLaboral.sucursal'
        db.add_column('persona_trayectorialaboral', 'sucursal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['compania.Sucursales'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TrayectoriaLaboral.aportaciones_fecha_final'
        db.add_column('persona_trayectorialaboral', 'aportaciones_fecha_final',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.aportaciones_fecha_inicial'
        db.add_column('persona_trayectorialaboral', 'aportaciones_fecha_inicial',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TrayectoriaLaboral.sucursal'
        db.delete_column('persona_trayectorialaboral', 'sucursal_id')
