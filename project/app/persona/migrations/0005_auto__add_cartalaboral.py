...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CartaLaboral'
        db.create_table('persona_cartalaboral', (
            ...
            ('tiene_carta', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('expide', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('fecha', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
        ))
        db.send_create_signal('persona', ['CartaLaboral'])


    def backwards(self, orm):
        # Deleting model 'CartaLaboral'
        db.delete_table('persona_cartalaboral')
