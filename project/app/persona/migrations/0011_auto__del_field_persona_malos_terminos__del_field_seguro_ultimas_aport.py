...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Persona.malos_terminos'
        db.delete_column('persona_persona', 'malos_terminos')

        # Deleting field 'Seguro.ultimas_aportaciones'
        db.delete_column('persona_seguro', 'ultimas_aportaciones')

        # Deleting field 'Seguro.registro_completo'
        db.delete_column('persona_seguro', 'registro_completo')


    def backwards(self, orm):
        # Adding field 'Persona.malos_terminos'
        db.add_column('persona_persona', 'malos_terminos',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seguro.ultimas_aportaciones'
        db.add_column('persona_seguro', 'ultimas_aportaciones',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Seguro.registro_completo'
        db.add_column('persona_seguro', 'registro_completo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
