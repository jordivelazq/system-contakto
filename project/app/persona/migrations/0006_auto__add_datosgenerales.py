...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DatosGenerales'
        db.create_table('persona_datosgenerales', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trayectoriaLaboral', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persona.TrayectoriaLaboral'], unique=True)),
            ('num_personas', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('puestos', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('tiene_valores', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('motivo_salida', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('motivo_salida_candidato', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('tiene_sindicato', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('nombre_sindicato', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('es_recontratable', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('recontratable_motivo', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
            ('tiene_mercancia', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tiene_informacion', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tiene_documentos', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tiene_efectivo', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('persona', ['DatosGenerales'])


    def backwards(self, orm):
        # Deleting model 'DatosGenerales'
        db.delete_table('persona_datosgenerales')
    ...
    models = {
        ...
        'persona.datosgenerales': {
            ...
            'es_recontratable': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
