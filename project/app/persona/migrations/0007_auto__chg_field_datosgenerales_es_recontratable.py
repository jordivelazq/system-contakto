...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DatosGenerales.es_recontratable'
        db.alter_column('persona_datosgenerales', 'es_recontratable', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'DatosGenerales.es_recontratable'
        db.alter_column('persona_datosgenerales', 'es_recontratable', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))
