...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Opinion.evaluacion'
        db.delete_column('persona_opinion', 'evaluacion_id')

        # Adding field 'Opinion.trayectoriaLaboral'
        db.add_column('persona_opinion', 'trayectoriaLaboral',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['persona.TrayectoriaLaboral']),
                      keep_default=False)

        # Adding field 'Opinion.nombre'
        db.add_column('persona_opinion', 'nombre',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Opinion.puesto'
        db.add_column('persona_opinion', 'puesto',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Opinion.telefono'
        db.add_column('persona_opinion', 'telefono',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Opinion.email'
        db.add_column('persona_opinion', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Opinion.categoria'
        db.alter_column('persona_opinion', 'categoria', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Adding field 'Opinion.evaluacion'
        db.add_column('persona_opinion', 'evaluacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['persona.Evaluacion']),
                      keep_default=False)

        # Deleting field 'Opinion.trayectoriaLaboral'
        db.delete_column('persona_opinion', 'trayectoriaLaboral_id')

        # Deleting field 'Opinion.nombre'
        db.delete_column('persona_opinion', 'nombre')

        # Deleting field 'Opinion.puesto'
        db.delete_column('persona_opinion', 'puesto')

        # Deleting field 'Opinion.telefono'
        db.delete_column('persona_opinion', 'telefono')

        # Deleting field 'Opinion.email'
        db.delete_column('persona_opinion', 'email')


        # Changing field 'Opinion.categoria'
        db.alter_column('persona_opinion', 'categoria', self.gf('django.db.models.fields.CharField')(max_length=20))
