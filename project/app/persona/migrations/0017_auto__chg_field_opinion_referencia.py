...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opinion.referencia'
        db.alter_column('persona_opinion', 'referencia', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Opinion.referencia'
        db.alter_column('persona_opinion', 'referencia', self.gf('django.db.models.fields.IntegerField')())
