...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Legalidad.antecedentes_penales'
        db.delete_column('persona_legalidad', 'antecedentes_penales')


    def backwards(self, orm):
        # Adding field 'Legalidad.antecedentes_penales'
        db.add_column('persona_legalidad', 'antecedentes_penales',
