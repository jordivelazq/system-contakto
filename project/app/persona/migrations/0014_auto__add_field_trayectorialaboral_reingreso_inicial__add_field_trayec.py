...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrayectoriaLaboral.reingreso_inicial'
        db.add_column('persona_trayectorialaboral', 'reingreso_inicial',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrayectoriaLaboral.reingreso_final'
        db.add_column('persona_trayectorialaboral', 'reingreso_final',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrayectoriaLaboral.reingreso_inicial'
        db.delete_column('persona_trayectorialaboral', 'reingreso_inicial')

        # Deleting field 'TrayectoriaLaboral.reingreso_final'
        db.delete_column('persona_trayectorialaboral', 'reingreso_final')
