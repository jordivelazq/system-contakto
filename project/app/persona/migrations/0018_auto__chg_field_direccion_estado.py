...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Direccion.estado'
        db.alter_column('persona_direccion', 'estado', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):

        # Changing field 'Direccion.estado'
        db.alter_column('persona_direccion', 'estado', self.gf('django.db.models.fields.CharField')(max_length=140))
    ...
    models = {
        ...
        'persona.opinion': {
            ...
            'puesto': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'referencia': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'telefono': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'trayectoriaLaboral': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persona.TrayectoriaLaboral']"})
        },
        'persona.origen': {
