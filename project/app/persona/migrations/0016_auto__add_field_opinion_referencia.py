...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opinion.referencia'
        db.add_column('persona_opinion', 'referencia',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opinion.referencia'
        db.delete_column('persona_opinion', 'referencia')
    ...
    models = {
        ...
        'persona.opinion': {
            ...
            'puesto': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'referencia': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'telefono': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True', 'blank': 'True'}),
            'trayectoriaLaboral': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persona.TrayectoriaLaboral']"})
        },
        'persona.origen': {
