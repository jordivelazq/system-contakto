...
class ClienteSolicitudesCanditatosFacturasListView(GroupRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(ClienteSolicitudesCanditatosFacturasListView, self).get_context_data(**kwargs)
...
class ClienteSolicitudDetaiFacturalView(GroupRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super(ClienteSolicitudDetaiFacturalView, self).get_context_data(**kwargs)

        context['title'] = "Cliente / Detalle de solicitud"

        context['cliente_solicitud_candidatos_facturas'] = ClienteSolicitudFactura.objects.filter(cliente_solicitud=self.object)
...
class ClienteSolicitudFacturaUpdateView(GroupRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super(ClienteSolicitudFacturaUpdateView, self).get_context_data(**kwargs)
    ...
    def get_success_url(self, **kwargs):
        ...
        return reverse('cobranza_facturas_detail', kwargs={"pk": self.kwargs['solicitud_id']})