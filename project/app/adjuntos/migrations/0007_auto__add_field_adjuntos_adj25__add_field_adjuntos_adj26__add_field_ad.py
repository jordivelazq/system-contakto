...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjuntos.adj25'
        db.add_column('adjuntos_adjuntos', 'adj25',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj26'
        db.add_column('adjuntos_adjuntos', 'adj26',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj27'
        db.add_column('adjuntos_adjuntos', 'adj27',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj28'
        db.add_column('adjuntos_adjuntos', 'adj28',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjuntos.adj25'
        db.delete_column('adjuntos_adjuntos', 'adj25')

        # Deleting field 'Adjuntos.adj26'
        db.delete_column('adjuntos_adjuntos', 'adj26')

        # Deleting field 'Adjuntos.adj27'
        db.delete_column('adjuntos_adjuntos', 'adj27')

        # Deleting field 'Adjuntos.adj28'
        db.delete_column('adjuntos_adjuntos', 'adj28')
