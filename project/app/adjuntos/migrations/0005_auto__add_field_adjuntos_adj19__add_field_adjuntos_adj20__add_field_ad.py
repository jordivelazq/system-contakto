...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjuntos.adj19'
        db.add_column('adjuntos_adjuntos', 'adj19',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj20'
        db.add_column('adjuntos_adjuntos', 'adj20',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj21'
        db.add_column('adjuntos_adjuntos', 'adj21',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjuntos.adj19'
        db.delete_column('adjuntos_adjuntos', 'adj19')

        # Deleting field 'Adjuntos.adj20'
        db.delete_column('adjuntos_adjuntos', 'adj20')

        # Deleting field 'Adjuntos.adj21'
        db.delete_column('adjuntos_adjuntos', 'adj21')
