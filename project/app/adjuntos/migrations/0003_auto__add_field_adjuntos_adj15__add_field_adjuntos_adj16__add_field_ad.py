...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adjuntos.adj16'
        db.add_column('adjuntos_adjuntos', 'adj16',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj17'
        db.add_column('adjuntos_adjuntos', 'adj17',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj18'
        db.add_column('adjuntos_adjuntos', 'adj18',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Adjuntos.adj16'
        db.delete_column('adjuntos_adjuntos', 'adj16')

        # Deleting field 'Adjuntos.adj17'
        db.delete_column('adjuntos_adjuntos', 'adj17')

        # Deleting field 'Adjuntos.adj18'
        db.delete_column('adjuntos_adjuntos', 'adj18')
    ...
    models = {
        'adjuntos.adjuntos': {
            ...
            'adj15': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
