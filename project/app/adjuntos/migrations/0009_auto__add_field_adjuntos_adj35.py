...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjuntos.adj35'
        db.add_column('adjuntos_adjuntos', 'adj35',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjuntos.adj35'
        db.delete_column('adjuntos_adjuntos', 'adj35')
    ...
    models = {
        'adjuntos.adjuntos': {
            ...
            'adj35': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
