...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjuntos.adj22'
        db.add_column('adjuntos_adjuntos', 'adj22',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj23'
        db.add_column('adjuntos_adjuntos', 'adj23',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Adjuntos.adj24'
        db.add_column('adjuntos_adjuntos', 'adj24',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjuntos.adj22'
        db.delete_column('adjuntos_adjuntos', 'adj22')

        # Deleting field 'Adjuntos.adj23'
        db.delete_column('adjuntos_adjuntos', 'adj23')

        # Deleting field 'Adjuntos.adj24'
        db.delete_column('adjuntos_adjuntos', 'adj24')
