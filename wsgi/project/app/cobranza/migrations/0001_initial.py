...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cobranza_cobranza', (
            ...
            ('folio', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True)),
            ('status_cobranza', self.gf('django.db.models.fields.CharField')(default='0', max_length=140, null=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('cobranza', ['Cobranza'])


    def backwards(self, orm):
        # Deleting model 'Cobranza'
        db.delete_table('cobranza_cobranza')
    ...
    models = {
        ...
        'cobranza.cobranza': {
            ...
            'folio': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'status_cobranza': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '140', 'null': 'True', 'blank': 'True'})
        },
        'compania.compania': {
