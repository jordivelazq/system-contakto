...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('adjuntos_adjuntos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('investigacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['investigacion.Investigacion'])),
            ('adj1', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj2', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj3', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj4', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj5', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj6', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj7', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj8', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj9', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj10', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj11', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj12', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('adj13', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('adjuntos', ['Adjuntos'])


    def backwards(self, orm):
        # Deleting model 'Adjuntos'
        db.delete_table('adjuntos_adjuntos')


    models = {
        'adjuntos.adjuntos': {
            'Meta': {'object_name': 'Adjuntos'},
            'adj1': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
